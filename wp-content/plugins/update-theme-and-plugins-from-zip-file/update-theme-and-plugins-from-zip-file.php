...
function jdsutpzip_update_theme_and_plugins_from_zip_file_options() {
		...
		<p>
			...
			<br><span style="font-size: 85%; font-style: italic;">When enabled, backup zip file of theme or plugin will be saved in current WordPress UPLOAD directory. A link will be provided when you do the upgrade.<br>When disabled, old version of theme or plugin will be deleted and will NOT be backed up.<br></span>
		</p>
		...
		<br><hr>How much is this plugin worth to you? A suggested <a href="https://www.paypal.me/jsherk/10usd">donation of $5 or $10</a> will help me feed my kids, pay my bills and keep this plugin updated!<br><a href="https://www.paypal.me/jsherk/10usd"><img width="175" src="<?php echo $pluginbut; ?>"></a><hr>
