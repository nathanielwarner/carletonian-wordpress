...
<div id="yop-main-area" class="bootstrap-yop wrap">
	...
	<form method="get" action="" id="searchForm">
		<input type="hidden" name="_token" value="<?php echo esc_attr( wp_create_nonce( 'yop-poll-view-logs' ) ); ?>">
		<p class="search-box">
			<label class="screen-reader-text" for="post-search-input">
				<?php esc_html_e( 'Search Logs', 'yop-poll' ); ?>:
			</label>
			<input type="hidden" name="page" value="yop-poll-logs">
			<input id="logs-search-input" name="q" value="<?php echo esc_attr( $params['q'] ); ?>" type="search">
			<input id="search-submit" class="button" value="<?php esc_html_e( 'Search Logs', 'yop-poll' ); ?>" type="submit">
		</p>
	...
	<div class="tablenav top">
		<div class="alignleft actions bulkactions">
			<input type="hidden" name="_bulk_token" value="<?php echo esc_attr( wp_create_nonce( 'yop-poll-bulk-logs' ) ); ?>">
			...
			<input class="button logs-bulk-action" data-position="top" value="<?php esc_html_e( 'Apply', 'yop-poll' ); ?>" type="submit">
		</div>
		<h2 class="screen-reader-text">
			<?php esc_html_e( 'Logs list navigation', 'yop-poll' ); ?>
		</h2>
		...
		foreach ( $logs as $log ) {
			...
			<tr class="iedit author-self level-0 post-17 type-post status-publish format-standard hentry category-uncategorized">
				<th scope="row" class="check-column">
					...
					<input name="logs[]" value="<?php echo esc_attr( $log['id'] ); ?>" type="checkbox">
				...
				<td class="title column-title has-row-actions column-primary page-title" data-colname="Poll Name">
					...
					<div class="row-actions">
                        <span class="view">
						    <a class="view-log-details" title="<?php esc_html_e( 'View details for this record', 'yop-poll' ); ?>"
                               href="#" data-id="<?php echo esc_attr( $log['id'] ); ?>"><?php esc_html_e( 'View Details', 'yop-poll' ); ?></a> |
					    </span>
						<span class="trash">
						    <a class="delete-log" title="<?php esc_html_e( 'Move this log record to the Trash', 'yop-poll' ); ?>"
						    href="#" data-id="<?php echo esc_attr( $log['id'] ); ?>"><?php esc_html_e( 'Trash', 'yop-poll' ); ?></a>
					    </span>
					</div>
	...
	<div class="tablenav top">
		<div class="alignleft actions bulkactions">
			...
			<input class="button logs-bulk-action" data-position="bottom" value="<?php esc_html_e( 'Apply', 'yop-poll' ); ?>" type="submit">
		</div>
		<h2 class="screen-reader-text">
